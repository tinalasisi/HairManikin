...
# import manikin data
ManikinData <- read_csv(here("data/tidy/Complete_ManikinData.csv"))
...
SolarInfluxData <- read_csv(here("data/tidy/SolarInfluxData.csv"))
...
EvaporativeData <- read_csv(here("data/tidy/EvaporativeData.csv"))
...
EvaporativeSolarInfluxData <- read_csv(here("data/tidy/EvaporativeSolarInfluxData.csv"))
