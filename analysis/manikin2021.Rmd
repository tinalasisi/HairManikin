...
Below, our results show that the most significant variables are wig and radiation, with marginal significance in radiation and the interaction between radiation and wig type (also, see Figure \@ref(fig:plt_lm_rawheatloss)). 
...
```{r plt_lm_rawheatloss, fig.cap="Dot-and-whisker plot for regression analysis of heatloss with only significant results shown."}
...
Below we present the results of a standardized version of the model above, which shows the same pattern of significance.
...
Viewed as an ANOVA, we confirm the same set of significant
```{r aov_rawheatloss_std}
...
ggstatsplot::ggcoefstats(
  ...
  palette = "dark",
  only.significant = T,
  caption = "Dot-and-whisker plot for standardized regression analysis of heatloss with only significant results shown."
)
